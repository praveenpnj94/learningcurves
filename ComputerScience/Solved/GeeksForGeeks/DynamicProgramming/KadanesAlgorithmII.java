...
Input Format:
The first line of input contains a number T denoting the number of testcases. T testcases follow. Each testcase contains two lines of input. The first line contains the size of the array sizeOfArr. The next line contains elements of the array arr separated by spaces.

Output Format:
For each testcase, in a new line, print the the maximum sum.
